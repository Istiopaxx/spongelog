...
[지난 포스트](https://spongelog.netlify.app/unix_system_outline_first/)에 이어서 시작하겠습니다.
...
이후에 [non-buffered I/O](https://spongelog.netlify.app/unix_file_io_basic/)와 **standard I/O**를 비교해보아도 차이가 느껴질 겁니다.
...
이번 포스트에서는 [저번 포스트](https://spongelog.netlify.app/unix_system_outline_first/)에 이어서 유닉스 시스템 개요에 대해 살펴보았습니다.
